...
class DiseaseService:
    ...
    async def predict(image_file: UploadFile) -> DiseasePredictionResponse:
        ...
        return DiseasePredictionResponse(
            ...
            organic_remedies=ai_recommendation.get("organic_remedies") or profile.get("organic_remedies", []),
            chemical_remedies=ai_recommendation.get("chemical_remedies") or profile.get("chemical_remedies", []),
